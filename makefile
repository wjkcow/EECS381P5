...
CPPS = p4_main.cpp Sim_object.cpp Island.cpp Ship.cpp Tanker.cpp Warship.cpp Cruiser.cpp Ship_factory.cpp Controller.cpp Model.cpp View.cpp Utility.cpp Track_base.cpp Geometry.cpp Navigation.cpp
